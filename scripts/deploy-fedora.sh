...
tar -C "$source_dir" -cf - package.json package-lock.json src assets diaper-gacha python DRESSUP_GUIDE.md CONTRIBUTOR_GUIDE.md GENERATION_TUNING_GUIDE.md QUEST_MAKING_GUIDE.md NPC_DIALOGUE_TREES.md PLAYER_CHECKLIST.md TESTING_GUIDE.md scripts/check-lidollid.mjs scripts/check-wallet.mjs scripts/check-runtime.mjs scripts/check-reports.mjs scripts/check-router.mjs scripts/fixtures | tar -C "$release" -xf -
