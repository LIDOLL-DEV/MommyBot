...
from appearance_catalog import appearance
...
def build(source):
    ...
    appearanceChoices = appearance(copy, hair)
    ...
    manifest = {"version": 3, "canvas": [387, 875], "bases": bases, "faces": faces, "hair": hair,
                "diapers": diapers, "clothes": clothes, "foods": foods, "bareCameras": bareCameras, "appearance": appearanceChoices, "wipeImage": wipeImage, "provenance": provenance}
