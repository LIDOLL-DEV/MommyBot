...
export function createHangmanWeb(config, game, sessions) {
  ...
  files.set("/hangman/atelier.css", readFileSync(new URL("../bot/atelier.css", import.meta.url))); // Reuse the established pastel theme without requiring an atelier session.
